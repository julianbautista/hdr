...
In \cite{dumerchatJoint2022}, we developed an analysis where we fit jointly 
...
(see Appendix A of \cite{dumerchatJoint2022} for an explicit derivation). 
...
\begin{figure}
  ...
  Extracted from \cite{dumerchatJoint2022}. 
  }
